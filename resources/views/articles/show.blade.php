        ...
        <tbody>
            @foreach ($articles as $item)
                <tr>
                    ...
                    <td class="border px-4 py-2"><img src="{{ $item->picUrl }}" class="w-12 h-30 object-cover rounded"
                            alt="{{ $item->title }}"></td>
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <a href="{{ route('articles.edit', $item->id) }}"
                            class="text-white px-2 py-1 rounded-md transition" style="background-color: green">Edit</a>
