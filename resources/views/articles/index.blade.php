...
<x-app-layout>
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('articles.create') }}" class="text-white px-4 py-2 rounded-md transition" style="background-color: rgb(11, 234, 26)">Create an Article</a>
        </div>
    </div>
            ...
            @foreach ($articles as $item)
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <a href="{{ route('articles.edit', $item->id) }}" class="text-white px-2 py-1 rounded-md transition" style="background-color: green">Edit</a>
